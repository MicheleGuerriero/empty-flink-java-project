...
public class AdEvent implements Serializable {
	...
	public AdEvent(String userId, String adId, String pageId, String adType, String eventType, Long eventTime,
			String ipAddress) {
		this.userId = userId;
		this.adId = adId;
		this.pageId = pageId;
	...
	public String toString() {
		...
		sb.append(this.userId + "," + this.adId + "," + this.pageId + "," + this.adType + "," + this.eventType + ","
				+ this.eventTime + "," + this.ipAddress);
		sb.append(")");
